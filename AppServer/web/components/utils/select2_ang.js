( function( angular ) {
  ...
  */
  ...
  .provider('ngynSelect2Config', function () {
    this.allowClear = function (allowClear) {
      this.allowClear = allowClear;
    };
    this.noSearch = function (noSearch) {
  ...
  .directive( 'ngynSelect2', ['$parse', '$interpolate', '$timeout', 'ngynSelect2Config', function( $parse, $interpolate, $timeout, ngynSelect2Config ) {
    return {
      require: '?ngModel',
      ...
      link: function link( scope, elm, attrs, ngModelController ) {
        ...
        if (ngynSelect2Config.noSearch) {
          options.minimumResultsForSearch = -1
        }

        if (angular.isDefined(attrs.searchResults)) {
          options.minimumResultsForSearch = attrs.searchResults;
        }
        ...
        function updateRequired( required ) {
          if (!ngynSelect2Config.allowClear) {
            return;
          } 
